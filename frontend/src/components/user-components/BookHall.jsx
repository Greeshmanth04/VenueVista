...
function BookHall() {
  ...
  async function handleFormSubmit(bookingData){
    ...
    if(tokenRes.data.message == "token verified successfully"){
      ...
      let res = await axios.post("http://localhost:4000/user-api/booking", bookingData);
    ...
    <div className="bookhall">
      ...
      <form action="" onSubmit={handleSubmit(handleFormSubmit)}>
        <div className="content content1">
          ...
          <select id="" {...register("hallname", {required: true})} value={selectedHall || ""} onChange={handleHallChange}>
