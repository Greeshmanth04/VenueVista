...
function Halls() {
  ...
  async function handleHallUpdate(hallData){
    ...
    let tokenRes = await axios.get(`${BASE_URL}/admin-api/protectedLogin`, config);
    if(tokenRes.data.message == "token verified successfully"){
      ...
      let res = await axios.put(`${BASE_URL}/admin-api/hall`, hallData);
  ...
  async function handleAddHall(hallData){
    ...
    if(tokenRes.data.message == "token verified successfully"){
      ...
      hallData.blockStatus = false;
      hallData.image = postImage.myFile;
      let res = await axios.post(`${BASE_URL}/admin-api/hall`, hallData);
  ...
  async function deleteHall(){
    ...
    let tokenRes = await axios.get(`${BASE_URL}/admin-api/protectedLogin`, config);
    if(tokenRes.data.message == "token verified successfully"){
      let res = await axios.delete(`${BASE_URL}/admin-api/hall/${selectedHall.name}`);
