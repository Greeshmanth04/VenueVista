...
//Book hall
userApp.post("/booking", expressAsyncHandler(async(req, res)=>{
...
//View user bookings
userApp.get("/user-bookings/:email", expressAsyncHandler(async(req, res)=>{
    let bookingsCollection = req.app.get("bookingsCollection");
...
//Cancel booking
userApp.put("/block-booking/:bookingID", expressAsyncHandler(async(req, res)=>{
    let bookingsCollection = req.app.get("bookingsCollection");
...
//Protected
userApp.get("/protectedLogin", verifyToken, expressAsyncHandler(async(req, res)=>{
